      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
            ...
            <button
                ...
                className="group flex h-10 w-10 items-center justify-center rounded-xl border border-border bg-surface text-text transition-all hover:-translate-y-0.5 hover:bg-surfaceHighlight hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/50"

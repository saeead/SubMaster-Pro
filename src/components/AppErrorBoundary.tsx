...
export class AppErrorBoundary extends React.Component<React.PropsWithChildren<Record<string, never>>, AppErrorBoundaryState> {
  ...
  public componentDidCatch(error: Error, info: React.ErrorInfo): void {
    ...
    // A stale localStorage payload was the common source of startup crashes.
    // Recover once automatically so users do not get trapped on an error screen.
    const recoveryKey = 'submaster_pro_settings_recovery_attempted';

  ...
  useEffect(() => {
    ...
    if (savedSettings) {
      try {
        ...
        // Settings are user-controlled local data. Validate every collection so
        // old or manually edited localStorage values cannot crash the UI.
        ...
        if (!Array.isArray(parsed.openAICompatibleServices)) parsed.openAICompatibleServices = [];

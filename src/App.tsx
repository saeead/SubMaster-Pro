  ...
  useEffect(() => {
    ...
    if (savedSettings) {
      try {
        ...
        if (!parsed.translationMethod || parsed.aiProvider === 'edge' || parsed.aiProvider === 'deeplx') parsed.translationMethod = 'default';
